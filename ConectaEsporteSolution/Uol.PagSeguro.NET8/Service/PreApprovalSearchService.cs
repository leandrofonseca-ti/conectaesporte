...
using Uol.PagSeguro.NET8.Parse;
...
namespace Uol.PagSeguro.NET8.Service
{
    ...
    public static class PreApprovalSearchService
    {
        ...
        /// <returns cref="T:Uol.PagSeguro.NET8.Transaction"><c>Transaction</c></returns>
        ...
        /// <returns cref="T:Uol.PagSeguro.NET8.PreApprovalSearchResult"><c>PreApprovalSearchResult</c></returns>
