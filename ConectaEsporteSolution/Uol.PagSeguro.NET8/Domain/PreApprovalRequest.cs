...
namespace Uol.PagSeguro.NET8.Domain
{
    ...
    public class PreApprovalRequest
    {
        ...
        /// </summary>
        /// <remarks>
        /// The expected currency values are defined in the <c cref="T:Uol.PagSeguro.NET8.Domain.Currency">Currencty</c> class.
        /// </remarks>
        ...
        {
            this.Currency = Uol.PagSeguro.NET8.Constants.Currency.Brl;
        }
